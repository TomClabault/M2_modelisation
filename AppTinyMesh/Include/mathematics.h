...
//{
//protected:
//  double this->operator()(3); //!< Components.
//public:
//  //! Empty
//  Vector() {}
...
inline float Vector::operator[] (unsigned int i) const
{
  return this->operator()(i);
}
...
{
  this->operator()(0) += u[0]; this->operator()(1) += u[1]; this->operator()(2) += u[2];
  return *this;
}
...
{
  this->operator()(0) *= a; this->operator()(1) *= a; this->operator()(2) *= a;
  return *this;
}
...
{
  return Vector(this->operator()(0) * a[0], this->operator()(1) * a[1], this->operator()(2) * a[2]);
}
...
{
  return Vector(1.0 / this->operator()(0), 1.0 / this->operator()(1), 1.0 / this->operator()(2));
}
...
//inline Vector operator* (const Vector& u, float a)
//{
...
\sa SquaredNorm
*/
inline float Norm(const Vector& u)
{
...
\sa Norm
*/
inline float SquaredNorm(const Vector& u)
{
...
\sa Math::Bilinear
*/
inline Vector Vector::Bilinear(const Vector& a00, const Vector& a10, const Vector& a11, const Vector& a01, float u, float v)
{
