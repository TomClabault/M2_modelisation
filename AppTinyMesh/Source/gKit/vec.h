...
struct Vector
{
    ...
    float& operator[] ( const unsigned int i ); // l'implementation se trouve en fin de fichier
      ...
      friend int operator<= (const Vector&, const Vector&);
        ...
        friend float SquaredNorm(const Vector&);
        ...
        friend Vector Lerp(const Vector&, const Vector&, float);
        static Vector Bilinear(const Vector&, const Vector&, const Vector&, const Vector&, float, float);
